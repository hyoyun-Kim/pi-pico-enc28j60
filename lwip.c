...
void main(void)
{
    ...
    // data sheet up to 20 mhz (ENC28J60 SPI Interface with Clock Speeds Up to 20 MHz)
    spi_baudrate = spi_init(SPI_PORT, 21000 * 1000);
    ...
    IP4_ADDR(&static_ip, 192, 168, 1, 100);
    ...
    while (1)
    {
        ...
        {   //주석 10_22
            ...
            //enc28j60WriteBuffer(packet_len, eth_pkt);
